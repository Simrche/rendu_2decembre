            ...
            <div id='left'>
                ...
                <ul>
                    <?php foreach ($recupSondage as $recupSondages) { ?>
                        <li>
                            <div class="ecart"><a href='sondage.php?lien=<?= $recupSondages['sond_lien'] ?>'><?= $recupSondages['sond_question'] ?></a></div><a href='sondage.php?lien=<?= $recupSondages['sond_lien'] ?>'>Par <?= $recupSondages['sond_createur'] ?></a>
                        </li>
                    <?php } ?>
                </ul>
                <div id='bas'>
